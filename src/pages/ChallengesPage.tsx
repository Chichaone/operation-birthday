...
const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Добро пожаловать в конкурс, где важно не угадать, а{" "}
          <strong>повторить увиденное максимально точно!</strong> 📸😄
        </p>
        <p style={{ marginTop: "0.5rem" }}>
          На экране появится фотография с позой, жестом или действием.
          Ваша задача — <strong>повторить её как можно похожее</strong>:
          положение тела, эмоции и даже настроение!
        </p>
        <ul style={{ textAlign: "left", marginTop: "0.5rem", marginBottom: "0.5rem" }}>
          <li>🎭 <strong>Поза:</strong> повторите положение рук, ног и корпуса</li>
          <li>😜 <strong>Эмоции:</strong> добавьте мимику и харизму</li>
          <li>🔥 <strong>Креатив:</strong> можно слегка переиграть — это даже приветствуется</li>
        </ul>
        <p style={{ marginTop: "0.5rem", fontStyle: "italic" }}>
          Здесь нет правильного или неправильного — только веселье, смелость и смех!
        </p>
      </>
    ),
    pointsHint: "Рекомендуется: не стесняться, включить фантазию и повторять с душой 💃📸",
  },
  {
    id: 2,
    title: "ВЕСЁЛЫЕ ЧЕЛЛЕНДЖИ",
    description: (
      <>
        <p>
          Добро пожаловать в <strong>ВЕСЁЛЫЕ ЧЕЛЛЕНДЖИ</strong> — сборник самых активных, смешных и неожиданных игр вечеринки! 🎉🔥
        </p>
        <p style={{ marginTop: "0.5rem" }}>
          Здесь вас ждут задания на ловкость, скорость, реакцию и чувство юмора.
          Каждый раунд — новое испытание, где важно не только победить, но и как следует повеселиться 😄
        </p>
        <p style={{ marginTop: "0.5rem" }}>
          Команды будут соревноваться, смеяться, импровизировать и зарабатывать очки самыми разными способами — от простых движений до настоящих мини-баттлов.
        </p>
    ...
    pointsHint: "Рекомендуется: быть активными, быстрыми и готовыми к веселью 😄",
  },
